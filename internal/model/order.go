...
type Order struct {
	...
	PaymentStatus string `gorm:"type:enum('pending','paid','expired');default:'pending'"`

	OrderStatus string `gorm:"type:enum('pending','confirmed','preparing','ready','completed','cancelled');default:'pending'"`
